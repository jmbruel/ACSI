...
<xsl:template name="header.navigation">
  ...
  <xsl:comment>#set var="LANG" value="doc-fr"</xsl:comment>
  <xsl:comment>#include virtual="../track"</xsl:comment>

      <div id="top">
          <h1>
            <a href="../index.fr" title="Page d'accueil de AMC">AMC</a>
          </h1>
	...
	<td class="milieu">
	<a href="../index.fr">Accueil</a> » <a href="index">Doc</a> » <xsl:apply-templates select="." mode="object.title.markup"/> &#160;&#160;&#160;
